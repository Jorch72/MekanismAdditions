        ...
        if(!player.isSneaking())
        {
            ...
            if(block != null)
            {
                if(world.isRemote)
                {
                    ...
                    if(!names.isEmpty())
                    {
                        player.addChatMessage(new TextComponentString(EnumColor.DARK_BLUE + "[Mekanism Additions]" + EnumColor.GREY + " " + LangUtils.localize("tooltip.keysFound") + ":"));
                        ...
                        player.addChatMessage(new TextComponentString(EnumColor.DARK_BLUE + "[Mekanism Additions]" + EnumColor.GREY + " " + LangUtils.localize("tooltip.noKey") + "."));
                    }
                }
